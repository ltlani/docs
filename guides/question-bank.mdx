...
- Platform streaming: AI Engine toggle for Discord, WhatsApp, and Telegram;
  separate from Ultra-only API SSE.
...
<AccordionGroup>
  ...
  <Accordion title="Does platform response streaming require Ultra?">
    No. The AI Engine toggle edits a Discord, WhatsApp, or Telegram message in
    place. Only public API SSE with `stream: true` is Ultra-only.
  </Accordion>
</AccordionGroup>
