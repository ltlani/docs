...
<Card title="Valley 3" icon="sparkles" href="/guides/valley-3">
  Learn about Verba's free roleplay, storytelling, and vision model.
</Card>
...
On Ultra, Discord, WhatsApp, and Telegram can show the beginning of a response
early and edit that message into the complete answer. This is separate from the
public API SSE path, which is also Ultra-only.
