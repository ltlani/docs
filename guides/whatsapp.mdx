...
When Response Streaming is enabled in the verb's AI Engine, WhatsApp can receive
the first useful part of the reply early and then see that message updated as
generation continues. If streaming is unavailable before any partial text is
sent, Verba falls back to a normal complete reply.
