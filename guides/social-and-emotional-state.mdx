...
In auto mode, Verba can gradually adjust the sliders after eligible
conversations in app chat and supported Discord, WhatsApp, Telegram, Slack,
Twitch, and Email flows. It considers the recent exchange and a small set of
