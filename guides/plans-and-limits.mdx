...
- Public API SSE (`stream: true`) is available on Ultra. The AI Engine's
  Discord/WhatsApp/Telegram response-streaming toggle is a separate feature.
...
| Platform edit-in-place streaming | Yes | Yes | Yes | Yes |
...
- Platform response streaming does not use the public API SSE entitlement.
