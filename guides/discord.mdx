...
All of these are enabled by default for new bots and are Discord-specific.
Multi-message behavior is configured in the AI Engine and can also affect
supported non-Discord surfaces; it is not an expression control.
