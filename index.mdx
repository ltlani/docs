...
<CardGroup cols={2}>
  ...
  <Card title="Valley 3" icon="sparkles" href="/guides/valley-3">
    Meet Verba's free model for roleplay, storytelling, and vision.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Slack module" icon="slack" href="/guides/slack">
    Give one Verb its own Slack app, channels, threads, expressions, and commands.
  </Card>
  <Card title="Twitch module" icon="twitch" href="/guides/twitch">
    Connect a broadcaster and separate bot identity for chat, moderation, and stream tools.
  </Card>
  <Card title="Email module" icon="envelope" href="/guides/email">
    Use a vanity address with Postmark-backed threaded replies and generated media.
  </Card>
  ...
  <Card title="API guide" icon="code" href="/guides/api">
    Use Verba programmatically from your own app or workflow. The API item in
    the integration switcher opens this guide directly; it has no connection flow.
  </Card>
</CardGroup>
